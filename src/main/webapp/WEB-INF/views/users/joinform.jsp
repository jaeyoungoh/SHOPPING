...
<tr><td>아이디 :</td><td><input type="text" name="user_id" id="i" /></td></tr>
<tr><td>패스워드 :</td><td><input type="password" name="pwd" id="pw"  /></td></tr>
<tr><td>이름 :</td><td><input type="text" name="name" id="n" /></td></tr>
<tr><td>이메일 :</td><td><input type="text" name="email" id="e" /></td></tr>
<tr><td>주소 :</td><td><input type="text" name="address" id="a" /></td></tr>
<tr><td>전화번호:</td><td><input type="text" name="phone" id="p" /></td></tr>


<tr><td><input type="button" value="가입요청" onclick="join()"></td><td><input type="button" value="가입취소" onclick="canceljoin()" /></td></tr>
</table>
