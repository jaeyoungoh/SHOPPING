    ...
    function html5Upload() {	
    	...
    	sUploadURL= '../../../multiplePhotoUpload';     //다중파일업로드 U
    	//다중파일 업로드 
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sCallback : '/${pageContext.request.contextPath}/editor/photo_uploader/popup/callback.html',  //업로드 이후  redirect 페이지 url 	    	sFiletype : "*.jpg;*.png;*.bmp;*.gif",						//허용할 파일의 형식. ex) "*", "*.*", "*.jpg", 구분자(;)	
